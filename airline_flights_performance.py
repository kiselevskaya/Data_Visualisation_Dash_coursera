...
app.layout = html.Div(children=[html.H1('US Domestic Airline Flights Performance',
                                ...
                                ], style={'display': 'flex'}),  # first outer division ends
                                # Second outer division starts
                                html.Div([
                                    ...
                                    dcc.Dropdown(id='input-year',
                                                 ...
                                                 style={'width': '80%', 'padding': '3px',
                                                        'font-size': '20px', 'text-align-last': 'center'}),
                                            ], style={'display': 'flex'}),  # second outer division ends
                                # Graphs
                                html.Div([], id='plot1'),
                                html.Div([
                                    html.Div([], id='plot2'),
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
    ...
    if chart == 'OPT1':
        ...
        bar_data, line_data, div_data, map_data, tree_data = compute_perform(df)
        ...
        # Compute required information for creating graph from the data
        avg_car, avg_weather, avg_nas, avg_sec, avg_late = compute_delay(df)
